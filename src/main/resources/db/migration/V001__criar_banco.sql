...
create table TBL_FUNCIONARIOS(
    COD_FUNCIONARIOS bigint GENERATED BY DEFAULT AS IDENTITY primary key,
    FT_AVATAR BYTEA,
    ds_tipo_imagem varchar(200),
...
create table TBL_HIERARQUIA_EXTERNA(
    ...
    COD_EMPRESA bigint,
    foreign key (COD_FUNCIONARIO) references TBL_FUNCIONARIO (COD_FUNCIONARIO),
    foreign key (COD_EMPRESA) references TBL_EMPRESA (COD_EMPRESA)
);
...
create table TBL_FUNCIONARIO_SECAO(
    COD_SECAO bigint,
    COD_FUNCIONARIO bigint,
    foreign key (COD_USUARIO) references TBL_SECAO (COD_SECAO),
...
create table TBL_FUNCIONARIO_SETOR(
    COD_SETOR bigint,
    COD_FUNCIONARIO bigint,
    foreign key (COD_USUARIO) references TBL_SETOR (COD_SETOR),
    foreign key (COD_FUNCIONARIO) references TBL_FUNCIONARIOS (COD_FUNCIONARIO)
);
...
create tabel TBL_FUNCIONARIO_FOLHA_PONTO(
    COD_FOLHA_PONTO bigint,
    COD_FUNCIONARIO bigint,
    foreign key (COD_FUNCIONARIO) references TBL_FUNCIONARIO (COD_FUNCIONARIO),
    foreign key (COD_FOLHA_PONTO) references TBL_FOLHA_PONTO (COD_FOLHA_PONTO)
);
